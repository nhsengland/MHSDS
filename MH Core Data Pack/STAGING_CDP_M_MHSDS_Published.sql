...
INPUT:  MHDInternal.STAGING_MH_UnsuppressedMHSDSPublicationFiles
		MHDInternal.Reference_CDP_Population_Data
		...
		MHDInternal.Reference_MHSDS_Submission_Tracker

OUTPUT: MHDInternal.STAGING_CDP_M_MHSDS_Published 
