...
SELECT 
	   ...
	   CCOALESCE(ph.Organisation_Name, st.Organisation_Name,s.ProvName) as Org_Name, --this was under the [ICB Name - CCG Code] naming convention in the NCDR table but in the [Reporting].[Ref_ODS_Commissioner_Hierarchies_ICB] table in UDAL this will become the SUB LOCATION name.
